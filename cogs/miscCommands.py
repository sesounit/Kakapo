...
class miscCommands(commands.Cog):
    ...
    async def version(self, context):
        ...
        mainEmbed.add_field(name="Changes:", value="Music System Changes + Happy Christmas :)")
        mainEmbed.add_field(name="Version Code:", value="v0.9.8", inline=False)
        mainEmbed.add_field(name="Date Released:", value="Decemember 24th, 2021", inline=False)
