...
class miscCommands(commands.Cog):
    ...
    async def version(self, context):
        ...
        mainEmbed.add_field(name="Changes:", value="An Imposter Among Us released, music system improved.")
        mainEmbed.add_field(name="Version Code:", value="v0.9.6", inline=False)
        mainEmbed.add_field(name="Date Released:", value="November 13th, 2021", inline=False)
